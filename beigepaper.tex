...
\fancyhead[R]{\today--Version 0.7.0}
\fancyfoot[C]{\thepage} 
...
\begin{document}
	...
	\section{Imagining Bitcoin as a Computer}
		...
		The Ethereum network is subservient to others in terms of one thing only: \textsc{Ether}, the native currency for Ethereum. Everything the system can do is bounded up in its ability to expend Ether in exchange for a particular amount of system performance in a certain direction. 
