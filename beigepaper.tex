...
%			\scriptsize{Maurelian} & \scriptsize{$\Xi$0.000000000\textbf{1}00000000} & \scriptsize{1,000,000,000} \\
...
\justify
		\section{Memory and Storage}
			...
			\subsection{World State}
				...
				\begin{enumerate}
				addresses and \textbf{\gls{account state}s} 
				\end{enumerate}
...
\subsection{Blocktree to Blockchain}
	...
	\appendix
	\section{Tree Terminology\supercite{wiki:xxx}}
